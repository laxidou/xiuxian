...
func CurrentGameRules() GameRules {
	...
	return GameRules{
		...
		Sections: []GameRuleSection{
			...
			{ID: "reincarnation", Title: "自动转世与跨世历史", Body: "死亡结算完成后，角色会立即在当前世界边界内的随机坐标自动转世，无需也不能手动选择位置。转世保留永久角色 ID、角色名与跨世历史，life_number 增加 1，并以零修为、零年龄和空闲移动状态开始新本世。转世坐标与死亡机缘坐标分别独立随机计算。"},
...
9. 死亡结算后立即在当前世界边界内的随机坐标自动转世；永久角色身份保留，life_number 增加，新本世从零修为和空闲状态开始，不存在手动转世工具。
